...
var Web3Client = /** @class */ (function () {
    ...
    Web3Client.prototype.send = function (method, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _options, gas;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, method.estimateGas(JSON.parse(JSON.stringify(_options)))];
                    case 1:
                        gas = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, method.send(_options)];
                    case 1:
                        receipt = _a.sent();
                        console.log('yoyo');
